...
Filtering the plots for genes with colocalized variants and combining every phenotype yields:
...
plot_title <- "{gsub(pattern='_', replacement=' ', x=tissue)} - coloc\nPrimary vs. secondary eQTL" %>% glue::glue()
...
Click on this [link](all_coloc_tissue.html) for a q-q plot for every phenotype.
